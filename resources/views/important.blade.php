...
@media (min-width: 62em) {
  ...
  <!-- Wrap the rest of the page in another container to center all the content. -->
    ...
    <div class="row featurette">
      ...
      <div class="col-md-5">
      <img src="https://st3.depositphotos.com/32772600/37265/v/950/depositphotos_372655850-stock-illustration-businessman-office-worker-manager-letter.jpg" class="img-fluid" alt="Responsive image">
